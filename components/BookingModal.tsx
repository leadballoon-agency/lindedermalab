              ...
              {step === 1 && (
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="yes">Yes, with Linde DermaLab</option>
              ...
              <div className="space-y-4 sm:space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Tatiana">Tatiana - Expert in Anti-Ageing & Skin Health</option>
                    <option value="sam">Sam - Senior Therapist</option>
                  </select>
                </div>
              ...
              <div className="space-y-4 sm:space-y-6 animate-fade-in">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="consent" className="text-sm text-neutral-600">
                    I consent to Aesthetics with Linde DermaLab contacting me regarding my booking request and understand that my information will be handled in accordance with the privacy policy.
                  </label>
                </div>
              </div>
              )}
