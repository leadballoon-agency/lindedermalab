      ...
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold mt-2 sm:mt-4">
            Expert Care from
            <span className="block gradient-text">Tatiana</span>
          </h2>
        </div>
            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl mx-auto max-w-sm lg:max-w-none">
              <div className="aspect-[4/5] sm:aspect-[4/5] relative">
                <img 
                  ...
                  alt="Tatiana - CO2 Laser Specialist" 
          ...
          <div className="space-y-4 sm:space-y-6 order-2 lg:order-2">
            ...
            <div className="hidden lg:block">
              <h3 className="font-display text-3xl font-bold">
                Tatiana
                <span className="block text-xl text-primary-600 font-normal mt-2">Expert in Anti-Ageing & Skin Health</span>
              </h3>
            </div>

            <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
              As an expert in anti-ageing and skin health with over a decade of experience in advanced aesthetic treatments, I specialize 
              in CO2 laser resurfacing to help you achieve remarkable skin transformation.
            </p>

            <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
              My expertise in skin health ensures the highest standards of safety and care throughout your treatment journey.
            </p>
