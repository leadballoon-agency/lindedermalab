        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8">
            <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-primary-100 rounded-full">
              ...
              <span className="text-primary-700 font-medium text-xs sm:text-sm">Marylebone's Premier CO2 Laser Clinic</span>
            </div>
            ...
            <p className="text-base sm:text-lg md:text-xl text-neutral-600 leading-relaxed">
              Transform your skin at Linde DermaLab's state-of-the-art Marylebone clinic. Expert CO2 laser treatments 
              for dramatic results in wrinkles, acne scars, and skin rejuvenation with medical precision.
            </p>
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full max-w-lg">
                  <div className="glass-effect rounded-2xl p-6 shadow-xl">
                    <div className="text-center">
                      <h3 className="text-xl font-bold text-neutral-800 mb-2">Linde DermaLab - Your Expert Practitioner</h3>
