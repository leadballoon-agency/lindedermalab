  ...
  const steps = [
    {
      ...
      description: 'Advanced Observ520 skin analysis and personalized treatment planning',
      icon: '💬',
      duration: '30 mins'
    },
    {
      ...
      description: 'Skin preparation protocol to optimize results',
      icon: '🧴',
      duration: '2 weeks'
    },
    {
      ...
      <div className="max-w-7xl mx-auto section-padding relative z-10">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-neutral-600 mt-2 sm:mt-4 max-w-2xl mx-auto px-4">
            A clear, structured approach to your transformation
          </p>
        </div>
