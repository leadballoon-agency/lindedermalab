    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://instagram.com/lindedermalab" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              ...
              <a href="https://facebook.com/lindedermalab" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="tel:+447436484802" className="hover:text-white">
                  +44 7436 484802
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Linde DermaLab. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
